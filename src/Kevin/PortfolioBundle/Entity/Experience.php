 ...
 * @ORM\Entity(repositoryClass="Kevin\PortfolioBundle\Repository\ExperienceRepository")
 */
class Experience
{
    /**
     * @ORM\ManyToOne(targetEntity="Kevin\PortfolioBundle\Entity\Profil", inversedBy="experiences", cascade={"persist"})
     ...
     * @var int
     *
     * @ORM\Column(name="endMonth", type="integer", nullable=true)
     */
    private $endMonth;
